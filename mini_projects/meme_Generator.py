...
#https://www.youtube.com/watch?v=myMeYLP_RVQ&ab_channel=RocketingDataScience
#https://github.com/rocketingdatascience/Python_Memes_Generator/blob/main/MemesGenerator.py
